...
from utils_1.dataset import OcrDataSet, DetectDataset
import os
...
class Trainer:
    def __init__(self, load_parameters=False):
        ...
        self.dataset = test.Get_Train_DataSet()

        self.dataloader = DataLoader(self.dataset, 256, True)
        ...
        self.optimizer = torch.optim.Adam(self.net.parameters(), lr=0.0000001)
    ...
    def __call__(self):
        ...
        print("The length of DataLoader :", len(self.dataloader))
        epoch = 0
